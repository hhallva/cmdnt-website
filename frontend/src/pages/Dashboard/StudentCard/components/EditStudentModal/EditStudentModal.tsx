...
import { getStudentImageSrc, isPhoneValid } from '../../../../../utils/students';
...
const EditStudentModal: React.FC<EditStudentModalProps> = ({ isOpen, onClose, student, contacts, onSave }) => {
    ...
    useEffect(() => {
        ...
        setFormErrors({});
        setError(null);
        setPhotoPreview(getStudentImageSrc(student.image));
        setPhotoError(null);
    ...
    const handleCropConfirm = (croppedDataUrl: string) => {
        ...
        setFormData(prev => ({ ...prev, image: base64Payload || null }));
    ...
    const validateForm = () => {
        ...
        contactsList.forEach((contact, index) => {
            ...
            if (!contact.phone?.trim()) {
                ...
                contactErrors.phone = 'Неверный формат телефона (+7XXXXXXXXXX).';
                contactsValid = false;
            }
